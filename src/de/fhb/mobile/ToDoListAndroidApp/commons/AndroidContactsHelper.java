...
public class AndroidContactsHelper {
	...
	public static List<Contact> getAllContacts(ContentResolver contentResolver){
		...
		while(people.moveToNext()) {
		   ...
		   int phoneNumberColumnIndex = people.getColumnIndex(PhoneLookup.NUMBER);
		   String phoneNumber = "";
	 ...
	 */
	// from http://stackoverflow.com/questions/6152442/how-to-get-contact-email-id
	public static String getMailAddress(ContentResolver contentResolver,
		...
		Cursor emails = contentResolver.query(Email.CONTENT_URI, null, Email.CONTACT_ID
				+ " = " + contactID, null, null);
	...
	public static String getPhoneNumber(ContentResolver contentResolver,
		...
		Cursor pCur = contentResolver.query(
				...
				new String[] { String.valueOf(contactID) }, null);
		if (pCur.moveToNext()) {
			int iNumber = pCur.getColumnIndex(ContactsContract.CommonDataKinds.Phone.NUMBER);
