...
public class GmailSender extends javax.mail.Authenticator {
	...
	public synchronized void sendEmail(String subject, String body,
		...
		try {
			...
			if (recipients.indexOf(RECIPIENTS_SEPARATOR) > 0)
	...
	protected static Logger logger = LoggerFactory.getLogger(GmailSender.class);
	...
	public static void composeEmail(Context context, String subject,
		...
		// determining the activity to use for sending
		Intent chosenIntent = Intent.createChooser(emailIntent,
				"Sending Email...");

		logger.info("determined intent for sending email: " + chosenIntent);
